...
public abstract class IndexType
{
    ...
    public static IndexableField instantiateField( String key, Object value, Index indexConfig )
    {
        if ( value instanceof Long )
        {
            return new LongField( key, (Long)value, Store.YES );
        }
        else if ( value instanceof Float )
        {
            return new FloatField( key, (Float)value, Store.YES );
        }
        else if ( value instanceof Double )
        {
            return new DoubleField( key, (Double)value, Store.YES );
        }
        else if (value instanceof Integer )
        {
            return new IntField( key, (Integer)value, Store.YES );
        }
        else
        {
            return new StringField( key, value.toString(), Store.YES );
        }
    }
