...
import org.neo4j.io.pagecache.TestPageCursor;
                                       ...
                                       CURSOR extends Store.RecordCursor<RECORD>>
{
    ...
    {
        int pageSize = 1024;
        pageCursor = new TestPageCursor( 0l, pageSize );
