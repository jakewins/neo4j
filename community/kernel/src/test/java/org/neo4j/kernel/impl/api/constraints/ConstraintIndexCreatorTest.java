...
public class ConstraintIndexCreatorTest
{
    ...
    {
        // given
        KernelStatement constraintCreationContext = mockedParts();
        KernelStatement indexCreationContext = mockedParts();
    ...
    public void shouldDropIndexIfPopulationFails() throws Exception
    {
        ...
        KernelStatement constraintCreationContext = mockedParts();
        KernelStatement indexCreationContext = mockedParts();
        KernelStatement indexDestructionContext = mockedParts();
    ...
    {
        // given
        KernelStatement indexDestructionTransaction = mockedParts();
        StatementState state = mockedState();
    ...
    {
        private final Iterator<KernelStatement> mockContexts;

        StubTransactor( KernelStatement... mockContexts )
        {
            super( null );
