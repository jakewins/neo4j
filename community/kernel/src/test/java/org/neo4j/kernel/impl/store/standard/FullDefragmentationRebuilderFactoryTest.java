...
public class FullDefragmentationRebuilderFactoryTest
{
    ...
    public void shouldFindHighestInUseWhenThereAreUnusedRecordsAtEndOfFile() throws Throwable
    {
        ...
        StandardPageCache cache = new StandardPageCache( fs, 1024, 1024 );
    ...
    private Store<TestRecord, TestCursor> newStore( EphemeralFileSystemAbstraction fs, File path, StandardPageCache
