...
describe "app.controllers.data.browser.DatabrowserController", ->

  beforeEach -> module "app.controllers.data.browser"
  ...
  describe "pagination",  ->
    ...
    it "should list no pages when result fits in one page", inject( ($rootScope, $controller, graphService) ->
      ...
      scope = $rootScope.$new()
      ctrl = $controller("DatabrowserController", {$scope: scope })
