...
window.require.define({"test/controllers/navigation_controller_test": function(exports, require, module) {
  var Navigation;
  ...
  describe('Navigation', function() {
    return beforeEach(function() {
      return this.controller = new Navigation();
    });
  });
  
}});

window.require.define({"test/models/carrie_test": function(exports, require, module) {
  var Carrie;

  Carrie = require('models/carrie');

  describe('Carrie', function() {
    return beforeEach(function() {
      return this.model = new Carrie();
    });
  });
...
window.require.define({"test/models/navigation_test": function(exports, require, module) {
  var Navigation;
  ...
  describe('Navigation', function() {
    return beforeEach(function() {
      return this.model = new Navigation();
    });
  });
...
window.require('test/controllers/navigation_controller_test');
window.require('test/models/carrie_test');
window.require('test/models/header_test');
window.require('test/models/navigation_test');
