...
object exceptionHandlerFor2_3 extends MapToPublicExceptions[CypherException] {
  ...
  def missingProcedureException(namespace: Seq[String], name: String, cause: Throwable): CypherException = throw new MissingProcedureException(namespace, name, cause)
