...
public class MarshlandPool<T> implements Pool<T>
{
    ...
    private final ThreadLocal<LocalSlot> puddle = new ThreadLocal<LocalSlot>()
    {
        @Override
        protected LocalSlot initialValue()
        {
    ...
    private final ReferenceQueue<LocalSlot> objectsFromDeadThreads = new ReferenceQueue<>();
    ...
    public T acquire()
    {
        ...
        LocalSlot localSlot = puddle.get();;
        ...
        LocalSlotReference slotReference = (LocalSlotReference) objectsFromDeadThreads.poll();
     ...
     */
    private class LocalSlotReference extends PhantomReference<LocalSlot>
    {
        private T object;
     ...
     */
    private class LocalSlot
    {
        private T object;
        private final LocalSlotReference phantomReference = new LocalSlotReference( this, objectsFromDeadThreads );
