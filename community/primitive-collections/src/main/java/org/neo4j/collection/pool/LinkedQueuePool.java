...
public class LinkedQueuePool<R> implements Pool<R>
{
    ...
    protected LinkedQueuePool( int minSize, Factory<R> factory)
    {
        this( minSize, factory, new CheckStrategy.TimeoutCheckStrategy( DEFAULT_CHECK_INTERVAL, new LongSupplier()
            {
                @Override
    ...
    protected LinkedQueuePool( int minSize, Factory<R> factory, CheckStrategy strategy, Monitor monitor )
    {
